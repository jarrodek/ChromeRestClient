...
public class RuntimeImpl implements ChromeRuntime {
	...
	public final native void getId(final RuntimeStringHandler handler) throws JavaScriptException /*-{
		...
		handler.@com.google.gwt.chrome.runtime.ChromeRuntime.RuntimeStringHandler::onResult(Ljava/lang/String;)(id);
	}-*/;
	...
	public final native void getManifest(ManifestHandler handler) throws JavaScriptException /*-{
		...
		handler.@com.google.gwt.chrome.runtime.ChromeRuntime.ManifestHandler::onManifest(Lcom/google/gwt/chrome/runtime/ManifestDetails;)(manifest);
	}-*/;
	...
	public final native void sendMessage(String extensionId, Object message, JavaScriptObject options,
		...
		if(!extensionId){
			...
			$wnd.chrome.runtime.sendMessage(extensionId, message, options, callback);
		}
	}-;*/

 ...
 * If function accept more than one argument this property should be array with next arguments.
 * In this case property `multiparam` must be set to true so the background page will distinguish 
 * list of parameters from list as a single argument.
 * 
 ...
 * 	// data will contain payload, params, source and response keys. The response contain result 
...
/**
 * Send message to the background page, wait for response and send the response back to 
 * the host page.
 */

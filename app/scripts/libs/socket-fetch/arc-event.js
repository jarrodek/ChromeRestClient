...
export class ArcEventTarget {
   ...
   * @param {Function} listener The object that receives a notification when an event of the
...
export class ArcEventSource extends ArcEventTarget {
  constructor() {
    super();
    /**

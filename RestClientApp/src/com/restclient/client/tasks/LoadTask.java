...
import com.restclient.client.TasksLoader;
...
public interface LoadTask {
	 ...
	 * to continue other tasks. If error occurr an callbacks onFailure call
	 ...
	 * about long execution time) and crashs handlers.
	 * 
	 * @param callback

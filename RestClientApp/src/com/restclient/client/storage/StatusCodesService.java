...
public interface StatusCodesService extends AppDatabase {
   ...
   * <code>label</code> - label for code (response text)
   * <code>desc</code> - long desc for code
  ...
  void insertCodes(Collection<StatusCodesInsertRow> codeList, RowIdListCallback callback);

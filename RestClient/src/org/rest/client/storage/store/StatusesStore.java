...
public class StatusesStore extends IndexedDbAdapter<Long, HttpStatusObject> {
	
	public final static String CODE_INDEX = "code";
	public static final String STORE_NAME = "statuses";
	
	public StatusesStore() {
	...
	public static void setVestion(IDBDatabase db) throws IDBDatabaseException {
		...
		newStore.createIndex(CODE_INDEX, CODE_INDEX, headersIndexParameters);

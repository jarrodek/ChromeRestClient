...
public interface TutorialDialog extends HasWidgets, HasHTML, IsWidget {
	 ...
	 *            referenced element
	 * @param direction
	 *            in what side of element it should be displayed. See
	 *            {@link Direction} for constants.
	 */
	void setReferencedElement(Element element, int direction);

	/**
	 * It only make sense if set {@link #setReferencedElement(Element, int)}.
	 * Set correction to referenced element position. By this pixels dialog will
	 * be moved from set element.
	 * 
	 * @param top
	 * @param left
	 */
	void setPositionCorrection(int top, int left);
	 ...
	 * 
	 * @param direction
	 *            See {@link Direction} for constants.
	 */

...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "restclient" because\n';
  ...
  $wnd.__gwt_activeModules['restclient'] = {
    'moduleName' : 'restclient',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/restclient.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['restclient'].superdevmode = true;

  var expectedSuffix = '/restclient.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + restclient + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:restclient';
  var devModeSessionKey = '__gwtDevModeSession:restclient';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/restclient/restclient.nocache.js';
  ...
  $wnd.__gwt_activeModules['restclient'].canRedirect = true;
  $wnd.__gwt_activeModules['restclient'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/restclient?user.agent=' + ua + '&_callback=' + callback;
